  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-4 relative min-h-screen">
      ...
      <div className="max-w-4xl mx-auto pt-16 sm:pt-20">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#4F46E5] mb-8 text-center">About Tajmahal</h1>
        ...
        <div className="bg-white p-6 sm:p-8 rounded-xl shadow-md mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-4">Our Story</h2>
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-4">Our Philosophy</h2>
              <p className="text-gray-600 mb-4">
          ...
          <div className="bg-[#F9FAFB] p-5 sm:p-6 rounded-lg">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-3">Meet Our Team</h3>
            <p className="text-gray-600">
        ...
        <div className="bg-[#4F46E5] text-white p-6 sm:p-8 rounded-xl shadow-md mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold mb-6">What Our Guests Say</h2>
